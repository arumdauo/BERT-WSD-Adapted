...
def train(args, model, tokenizer, train_dataloader, eval_during_training=False):
    ...
    if os.path.exists(args.model_name_or_path):
        ...
        ''' Modifica da fare:
            Il global_step definito così non funziona, perché nel path dei file del model di BERT italiano
            non c'è un intero. Modificare il path o mettere "global_step = 1" (o altro intero).
        '''
        global_step = 4
